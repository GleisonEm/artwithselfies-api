...
def auto_rotate(path_original):
    ...
    if not exif:
        if width > height:
            ...
            image.save('static/img/app-image-certa.png', quality=100)
            print('passei aq2 ')
        ...
        if orientation_key in exif:
            ...
            if orientation in rotate_values:
                ...
                print('image', image)
                image.save('static/img/app-image-certa.png', quality=100, exif=str(exif))
                return Response('True')
        else:
            if width > height:
                image = image.rotate(90)
